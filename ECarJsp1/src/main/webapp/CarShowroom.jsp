...
<body>
	...
	<div class="container" align="center">
		<div class="card" id="card1" style="width: 500px">
			<a href="https://cars.tatamotors.com/cars/altroz"><img
				class="card-img-top" src="images/tata_altroz.jpg" alt="Card image"
				style="width: 100%"></a>
			<div class="card-body">
				<form action="RentCarThroughShowRoom.jsp">
					...
					<p class="card-text">Overall the exterior design is edgy, sharp
						...
						measures 3990 mm long, 1755 mm wide and 1523 mm height. The
						premium hatchback comes with a 2501 mm long wheelbase and an
						unladen ground clearance of 165 mm.</p>
					<p class="card-text">he Tata Altroz interiors has a new
						...
						the easy attention of the users. The driver seat with height
						adjust feature, rear seats with ample leg space and headroom with
						foldable backrest for extending the luggage space can be expected</p>
					<input type="submit" class="btn btn-primary buttons"
						name="Rent Car" value="Rent Tata Altroz">
				</form>
			</div>
		</div>
		<div class="card" id="card2" style="width: 500px">
			<a href="https://auto.mahindra.com/suv/xuv700/"> <img
				class="card-img-top" src="images/Mahindra2.jpg" alt="Card image"
				style="width: 100%">
			</a>
			<div class="card-body">
				<form action="RentCarThroughShowRoom.jsp">
					...
					<p class="card-text">here’s a reason why this is called the
					...
					<input type="submit" class="btn btn-primary buttons"
						name="Rent Car" value="Rent Mahindra XUV700">
				</form>
			</div>
		</div>
		<div class="card" id="card3" style="width: 500px">
			<a href="https://www.kia.com/in/home.html"> <img
				class="card-img-top" src="images/KiaSeltos.jpg" alt="Card image"
				style="width: 100%">
			</a>
			<div class="card-body">
				<form action="RentCarThroughShowRoom.jsp">
					...
					<p class="card-text">As you get in, you are greeted with an
						...
						next to the large driver’s information console. Since this piece
						of tech is standard in practically all the trim (except the base),
						it definitely will be one of the key attractions for buyers.</p>
					<input type="submit" class="btn btn-primary buttons"
						name="Rent Car" value="Rent Kia Seltos">
				</form>
			</div>
		</div>
		<div class="card" id="card4" style="width: 500px">
			<a href="https://www.hondacarindia.com/honda-city"> <img
				class="card-img-top" src="images/HondaCity.jpg" alt="Card image"
				style="width: 100%">
			</a>
			<div class="card-body">
				<form action="RentCarThroughShowRoom.jsp">
					...
					<p class="card-text">The Honda City has 1 Diesel Engine and 1
						...
						the City has a mileage of 17.8 to 24.1 kmpl. The City is a 5
						seater and has length of 4549mm, width of 1748mm and a wheelbase
						of 2600mm. The price of Honda City starts at Rs. 11.16 Lakh and
						goes upto Rs. 15.11 Lakh.</p>

					<input type="submit" class="btn btn-primary buttons"
						name="Rent Car" value="Rent Honda City">
				</form>
			</div>
		</div>
		<div class="card" id="card5" style="width: 500px">
			<a href="https://www.toyotabharat.com/showroom/fortuner/"> <img
				class="card-img-top" src="images/ToyotaCar.jpg" alt="Card image"
				style="width: 100%">
			</a>
			<div class="card-body">
				<form action="RentCarThroughShowRoom.jsp">
					...
					<p class="card-text">Toyota Fortuner Price: Toyota retails the
						...
						layout. Toyota Fortuner Powertrains: It is offered with both
						petrol and diesel engines. While the 2.7-litre petrol unit
						(166PS/245Nm) is</p>
					<input type="submit" class="btn btn-primary buttons"
						name="Rent Car" value="Rent Toyota Fortuner">
				</form>
			</div>
		</div>
		<div class="card" id="card6" style="width: 500px">
			<a href="https://www.skoda-auto.co.in/models/new-octavia/new-octavia">
			...
			<div class="card-body">
				<form action="RentCarThroughShowRoom.jsp">
					...
					<p class="card-title">Skoda Octavia Engine and Transmission: It
						...
						(190PS/320Nm)</p>
					<input type="submit" class="btn btn-primary buttons"
						name="Rent Car" value="Rent Skoda Octavia">
				</form>
			</div>
		</div>

		<div class="card" id="card7" style="width: 500px">
			<a href="https://www.india.ford.com/suvs/endeavour/"><img
				class="card-img-top" src="images/Ford.jpg" alt="Card image"
				style="width: 100%"></a>
			<div class="card-body">
				<form action="RentCarThroughShowRoom.jsp">
					...
					<p class="card-text">Ford Endeavour is a 7 seater SUV available
						...
						variants, a 1996 cc, BS6 and a single Automatic transmission.
						Other key specifications of the Endeavour include a kerb weight of
						2415kg, ground clearance of and boot space of Liters. The
						Endeavour is available in 3 colours.</p>
					<p class="card-text">
						<input type="submit" class="btn btn-primary buttons"
							name="Rent Car" value="Rent Ford Endeavour">
				</form>
			</div>
		</div>

		<div class="card" id="card8" style="width: 500px">
			<a href="https://www.datsun.co.in/vehicles/new-vehicles/GO-Plus.html">
			...
			<div class="card-body">
				<form action="RentCarThroughShowRoom.jsp">
					...
					<p class="card-text">Datsun GO Plus is a 7 seater MUV available
						...
						weight of 950kg, ground clearance of and boot space of 347 (3rd
						row folded) Liters.</p>
					<input type="submit" class="btn btn-primary buttons"
						name="Rent Car" value="Rent Datsun Go Plus">
				</form>
			</div>
		</div>
	</div>
